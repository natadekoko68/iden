...
# print(df_mydata_concat)
df_mydata_samples = []
for i in df_mydata_concat["Sample Name"].unique():
    # df_mydata_samples.append(df_mydata_concat[df_mydata_concat["Sample Name"] == i])
    # print(df_mydata_concat[df_mydata_concat["Sample Name"] == i])
    q = df_mydata_concat[df_mydata_concat["Sample Name"] == i]["Relative Quantity"].quantile(0.99)
    df_mydata_samples.append(df_mydata_concat[df_mydata_concat["Sample Name"] == i][df_mydata_concat[df_mydata_concat["Sample Name"] == i]["Relative Quantity"]<=q])
